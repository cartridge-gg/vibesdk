          ...
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="flex-1 text-center md:text-left">
              <div className="flex flex-col md:flex-row items-center gap-4 mb-2">
                <h1 className="text-3xl font-bold">{getAuthUserPrimaryLabel(user)}</h1>
              ...
              <p className="text-text-tertiary mb-1">{getAuthUserSecondaryLabel(user)}</p>
            ...
            <Card className="dark:bg-bg-4/50 max-w-xl">
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="email">{user?.walletAddress ? 'Controller Account' : 'Email'}</Label>
